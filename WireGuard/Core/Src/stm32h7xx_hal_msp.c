...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_INP5 
    */
    GPIO_InitStruct.Pin = AI_07_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AI_07_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AI_08_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AI_08_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1 
    */
    GPIO_InitStruct.Pin = AI_01_Pin|AI_02_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5 
    */
    HAL_GPIO_DeInit(AI_07_GPIO_Port, AI_07_Pin);

    HAL_GPIO_DeInit(AI_08_GPIO_Port, AI_08_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1 
    */
    HAL_GPIO_DeInit(GPIOF, AI_01_Pin|AI_02_Pin);

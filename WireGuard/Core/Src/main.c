...
int main(void)
{
  ...
  osThreadDef(defaultTask, MAIN_taskEntry, osPriorityNormal, 0, 512);
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_RTC|RCC_PERIPHCLK_USART1
                              |RCC_PERIPHCLK_SPI5|RCC_PERIPHCLK_SDMMC
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : AVDD_EN_Pin */
  GPIO_InitStruct.Pin = AVDD_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(AVDD_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : RF_DIO5_Pin RF_DIO1_Pin */
  GPIO_InitStruct.Pin = RF_DIO5_Pin|RF_DIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : RF_SLAVE_READY_Pin */
  GPIO_InitStruct.Pin = RF_SLAVE_READY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(RF_SLAVE_READY_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : RF_MASTER_READY_Pin */
  GPIO_InitStruct.Pin = RF_MASTER_READY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(RF_MASTER_READY_GPIO_Port, &GPIO_InitStruct);
...
__weak void MAIN_taskEntry(void const * argument)
{
  /* init code for FATFS */
  MX_FATFS_Init();
